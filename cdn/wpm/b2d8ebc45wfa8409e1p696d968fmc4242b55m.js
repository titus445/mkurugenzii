(() => {
    ...
    n.amdO = {}, (() => {
        ...
        function N(e) {
            ...
            for (let n = 0; n < t.length; n++) {
                ...
                if (e === decodeURIComponent(o)) {
                    I[e] = JSON.parse(decodeURIComponent(r));
                    break
                }
            }
            return I[e]
        ...
        const be = "production",
            we = "0.0.371",
            ve = "modern",
            ge = "2d8ebc45wfa8409e1p696d968fmc4242b55",
            ye = {
                        ...
                        try {
                            l = function(e, t) {
                                ...
                                const o = {
                                    ...
                                    columnNumber: "1",
                                    method: t.context,
                                    file: "https://cdn.shopify.com/b2d8ebc45wfa8409e1p696d968fmc4242b55m.js"
                                };
        ...
        function At(e) {
            ...
            return {
                ...
                publishDomEvent(e, t, n) {
                    if (!he("web_pixels_dom_analytics")) throw new Ct("This feature is disabled");
                    if ("string" != typeof e) {
                        const t = JSON.stringify(e);
                        throw new Ct(`Expected event name "${t}" to be a string, but got ${typeof e}`)
                    }
                    if (!it(e)) throw new Ct(`Event name "${e}" is not a supported DOM Event`);
                    const r = ut(t);
                    if (!r.isValid) throw new Ct(`Input Validation Error: ${r.error}`);
        ...
        const St = ["31014027265", "28638674945", "44186959873"];
        const kt = Symbol.for("RemoteUi::Retain"),
            It = Symbol.for("RemoteUi::Release"),
        ...
        class Rt {
            ...
            add(e) {
                this.memoryManaged.add(e), e[Nt].add(this), e[kt]()
            }
            release() {
                for (const e of this.memoryManaged) e[Nt].delete(this), e[It]();
                this.memoryManaged.clear()
            }
        }

        function Pt(e) {
            return Boolean(e && e[kt] && e[It])
        }
        ...
        function Ot(e, {
            ...
            const n = Pt(e);
            if (n && e[kt](), t) {
                if (Array.isArray(e)) return e.reduce(((e, n) => Ot(n, {
                    deep: t
                }) || e), n);
                if ("object" == typeof e && null != e) return Object.keys(e).reduce(((n, o) => Ot(e[o], {
                    deep: t
                }) || n), n)
            }
            return n
        ...
        async function jt({
            ...
            const {
                search: o
            } = self.location, r = t.id, i = [Ne(n), "/wpm", `@${ge}`, `/web-pixel-${r}`, `@${t.scriptVersion}`, "/sandbox", "/modern", /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, o];
            if (n.match(/spin\.dev\/?/)) {
                const e = o.length ? "&" : "?";
        ...
        function Bt(e, t, n, o, r, i = !1) {
            ...
            return {
                analytics: {
                    subscribe: (r, a, s) => (i && Ot(a), e.subscribe(r, a, { ...s,
            ...
            switch (e.runtimeContext) {
                case gt.Strict:
                    a = await async function({
                        ...
                        const o = t.id,
                            r = [Ne(n), "/wpm", `@${ge}`, `/web-pixel-${o}`, `@${t.scriptVersion}`, "/sandbox", "/worker.modern.js"];
                                ...
                                function(e, t) {
                                    Vt("submit", (t => {
                                        ...
                                        for (let e = 0; e < n.elements.length; e++) {
                                            ...
                                            (t instanceof HTMLInputElement || t instanceof HTMLSelectElement || t instanceof HTMLTextAreaElement || t instanceof HTMLButtonElement) && o.push(Kt(t))
                                        }
                            ...
                            if (he("web_pixels_visitor_api")) {
                                ...
                                const e = (v = {
                                    ...
                                    visitor: (e, t) => function(e, t, n) {
                                        ...
                                        if (!o.valid) throw new Yt(o.error || "Invalid input payload to visitorApi");
                                        const r = { ...e,
                                            ...t,
